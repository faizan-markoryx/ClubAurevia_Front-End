...
const AdminNavbar = () => {
  ...
  const linkClass =
    "px-4 py-2 rounded-lg text-sm font-medium hover:bg-secondary transition text-primary";
      ...
      <nav className="bg-white shadow-sm border-b">
        <div className="mx-auto px-8 py-3 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-2 flex-wrap">
            ...
            <NavLink to="/admin/trip-inquiry" className={linkClass}>
              Trip Inquiry
            </NavLink>
            ...
            <NavLink to="/admin/login" className={`px-4 py-2 rounded-lg text-sm font-medium transition text-primary border border-primary hover:bg-red-700 hover:text-white hover:border-transparent`}>
              Logout
            </NavLink>
