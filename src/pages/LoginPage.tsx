    ...
    try {
      ...
      if (res.success) {
        ...
        const userData: any = {
          ...
          welcomeLetter: res?.user?.welcomeLetter,
          activeMembership: res?.user?.activeMembership,
        }

        if(!userData?.activeMembership) return toast.error("Your profile is under verification")
    ...
    <div className="min-h-screen w-full flex flex-col md:flex-row">
      ...
      <div className="lg:w-1/2 min-h-screen sm:h-full w-full flex items-center justify-center bg-[#f3f3f3] px-6 py-12">
        <div className="w-full max-w-md">
          ...
          >
            <div className="flex justify-start items-center gap-2 pb-4 cursor-pointer">
              <div>
          ...
          <div className="flex justify-end mb-6">
            <Link
              to={"/forgot-password"}
              className="text-sm text-[#16302C] hover:underline"
            >
              Forgot Password?
            </Link>
          </div>
